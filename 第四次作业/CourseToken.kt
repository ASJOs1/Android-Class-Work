...
fun TokenLayout(modifier: Modifier=Modifier.fillMaxSize()) {
    ...
    Column(
        ...
        Text(text = stringResource(R.string.calculate_token),
            modifier= Modifier
        ...
        Text(text = stringResource(R.string.token_amount,token),)
...
fun EditNumberField(
    ...
    TextField(
        ...
        modifier=modifier,
        label = {
    Text(text = stringResource(R.string.need_token))
},
singleLine = true,
